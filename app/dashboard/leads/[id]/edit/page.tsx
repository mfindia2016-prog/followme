...
export default function EditLeadPage() {
  ...
  // User can change the product at any time.
  ...
  useEffect(() => {
    async function loadLead() {
      ...
      // IMPORTANT:
      // Product comes directly from leads.product
      ...
      setReminderEnabled(
        currentLead.reminder_enabled ?? true
      );

      // Prefer separate date/time fields.
      ...
      // Fallback to next_followup_at if date/time fields
      // are empty.
      if (
        !currentLead.next_follow_up_date &&
  ...
  async function handleSubmit(
    ...
    try {
      ...
      const updateData = {
        ...
        // PRODUCT CAN BE CHANGED MANUALLY
        product:
          product.trim(),
    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Update customer, product, agent and
            follow-up details.
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <div className="field">
            ...
            >
              You can manually enter or change
              the product. Auto-imported leads can
              also fill this field.
            </p>
          </div>
        </div>
